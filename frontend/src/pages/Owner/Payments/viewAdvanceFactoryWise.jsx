      ...
      <div className="flex items-center justify-between mb-6 border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-[#165E52] flex items-center gap-2">
            <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full border-2 border-[#165E52] bg-yellow-50 text-[#165E52] font-semibold text-base shadow-sm">
              Advances Given
            </span>
          </h2>
          <p className="text-gray-500 mt-1 text-base">
            Breakdown of total advances given to suppliers, by factory.
          </p>
        </div>
        <button
          onClick={() => navigate(-1)}
